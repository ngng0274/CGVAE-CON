...
class ChemModel(object):
    ...
    def make_model(self):
        ...
        self.ops['z_sampled_1'] = self.augmented_by_gaussian_noise()
        # Augmented by Gaussian noise
        self.ops['z_sampled_2'] = self.augmented_by_gaussian_noise()
    ...
    def augmented_by_gaussian_noise(self):
        raise Exception("Model have to implement augmented_by_gaussian_noise!")
        ...
        for step, batch_data in enumerate(batch_iterator):
            ...
            if is_training:
                ...
                fetch_list = [self.ops['loss'], self.ops['train_step'], 
                              ...
                              self.ops['qed_computed_values'], self.placeholders['target_values'], self.ops['l2_norm'], self.ops['total_l2_norm'], self.ops['total_qed_loss'],
